...
<div class="about-section">
   <h1>About Us Page</h1>
   <p>Founded in 2022, EgBooking has grown from a small Egyptian Students Group.</p>
   <p> our mission is to make it easier for everyone to experience Egypt.</p>
</div>
<div class="cards">
...
<div class="row">
  <div class="column">
    <div class="card">
      <div class="container">
        <h2>Nadine Muhamed</h2>
        <p class="title">CEO</p>
        <p>nadinesamy@gmail.com</p>
      </div>
    </div>
  </div>
