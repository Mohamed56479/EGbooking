<?php include('complaintserver.php'); ?>
<html>
    <head>
        <meta charset="UTF-8">
    ...
    <div class="container">
        <form action="" method="post">
            <h1><b>Complaint Form</b></h1><br>

            <label>User Name:</label><br>
            <input type="text" class="txt" name="username" placeholder="Enter your name" required><br>

            <label>Email:</label><br>
            <input type="email" class="txt" name="email" placeholder="Enter your email" required><br>
            ...
            <br>
            <br>
            <label for="subject"><b>Complaint Details:</b></label><br>
            <textarea class="subject" name="data" placeholder="Enter your complaint details......." style="height:200px" required></textarea><br>
            <br>
