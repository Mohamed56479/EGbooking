...
<body>
   <nav class="navbar navbar-expand-lg navbar-dark" style="background-color: #112B3C;">
      <div class="container">
         <a class="navbar-brand" href="Starter.php"><img src="img/icons8-hotel-64.png" alt=""> EGBooking</a>
      ...
      <div class="collapse navbar-collapse" id="navbarNav">
        <ul class="navbar-nav ml-auto">
          ...
          <li class="nav-item">
            <a class="nav-link" href="Starter.php#footer">Contact Us</a>
          </li>
      ...
      <div class="card">
        <div class="card-body">
          <form action="forgotpassword.php" method="post">
            ...
            <a class="a-link"href="#">Please Enter Your Email</a>
            <input name="email" type="email" placeholder="Email" required />
            <a href="signup.php"><button name="Forgot" type="submit" style="margin: 7px;">Enter</button></a>
         </form>
        </div>
      </div>
     </div>
